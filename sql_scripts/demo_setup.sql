    ...
    -- Repository: https://github.com/nitin-rane/Snowflake_AI_DEMO.git
    -- ========================================================================
...
use role accountadmin;
    ...
    CREATE OR REPLACE API INTEGRATION git_api_integration
        ...
        API_ALLOWED_PREFIXES = ('https://github.com/nitin-rane/')
        ENABLED = TRUE;
...
use role SF_Intelligence_Demo;
    ...
    CREATE OR REPLACE GIT REPOSITORY SF_AI_DEMO_REPO
        ...
        ORIGIN = 'https://github.com/nitin-rane/Snowflake_AI_DEMO.git';
